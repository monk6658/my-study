...
public class MyThreadPoolExecutor extends ThreadPoolExecutor {
    ...
    protected void beforeExecute(Thread t, Runnable r) {
        ...
        System.out.println("当前线程："+ t.getThreadGroup().getName() + " " + t.getName()+ "正准备执行任务......start");
    }
    ...
    public static void main(String[] args) throws InterruptedException {
        ...
        MyThreadPoolExecutor myThreadPoolExecutor = new MyThreadPoolExecutor(2, 2, 0L, TimeUnit.MILLISECONDS,new LinkedBlockingQueue<>(),customizableThreadFactory);
